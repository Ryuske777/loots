#steps : - open R studio -> top left corner file -> new file -> R script -> put mtcars.csv file in the R studion ke 
#         working directory (maybe the document folder) --> when you will execute your first code you will have to save
#         yuor R file in the same directory of mtcars.csv (document folder)  [give file name and save as type empty]--->paste-- save -- run.
